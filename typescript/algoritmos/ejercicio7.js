...
(function () {
    ...
    // Imput1
    var firstSide = reader.question("Put the First Side of the Triangle... ");
    var secondSide = reader.question("Put the Seconde Side of the Triangle... ");
    var thirdSide = reader.question("Put the Third Side of the Triangle... ");
    // Data Processing1
