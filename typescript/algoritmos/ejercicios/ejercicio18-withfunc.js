...
exports.getMinPositiveValue = void 0;
var getMinPositiveValue = function (array) {
    var positiveNumbers = array.filter(function (item) { return item > 0; });
    return Math.min.apply(Math, positiveNumbers);
};
exports.getMinPositiveValue = getMinPositiveValue;
// (()=> {
