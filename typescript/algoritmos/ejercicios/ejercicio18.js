...
var floatNumbers = parseFloat(ejercicio_services_1.reader.question("Put one of 6 float numbers at a time..."));
// Data procesing
arrNumbers.push(floatNumbers);
console.log(arrNumbers);
while (arrNumbers.length < 6) {
    floatNumbers = parseFloat(ejercicio_services_1.reader.question("Put one of 6 float numbers at a time..."));
    arrNumbers.push(floatNumbers);
    console.log(arrNumbers);
}
;
