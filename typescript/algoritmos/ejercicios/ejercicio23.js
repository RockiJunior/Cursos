...
(function () {
    ...
    var firstVocal = function (vocal) {
        return vocal.split("a").length - 1;
    };
    var secondVocal = function (vocal) {
        return vocal.split("e").length - 1;
    };
    var thirdVocal = function (vocal) {
        return vocal.split("i").length - 1;
    };
    var fourthVocal = function (vocal) {
        return vocal.split("o" && "ó").length - 1;
    };
    var fifthVocal = function (vocal) {
    ...
    console.log("", "Phrase 1...", "a:", firstVocal(texto1), "e:", secondVocal(texto1), "i:", thirdVocal(texto1), "o:", fourthVocal(texto1), "u:", fifthVocal(texto1), '\n', "Phrase 2...", "a:", firstVocal(texto2), "e:", secondVocal(texto2), "i:", thirdVocal(texto2), "o:", fourthVocal(texto2), "u:", fifthVocal(texto2), '\n', "Phrase 3...", "a:", firstVocal(texto3), "e:", secondVocal(texto3), "i:", thirdVocal(texto3), "o:", fourthVocal(texto3), "u:", fifthVocal(texto3), '\n', "Phrase 4...", "a:", firstVocal(texto4), "e:", secondVocal(texto4), "i:", thirdVocal(texto4), "o:", fourthVocal(texto4), "u:", fifthVocal(texto4), '\n', "Phrase 5...", "a:", firstVocal(texto5), "e:", secondVocal(texto5), "i:", thirdVocal(texto5), "o:", fourthVocal(texto5), "u:", fifthVocal(texto5));
    countWords(texto1);
